...
- <PostLink url="https://nextjs.org">Nextjs</PostLink> for frontend user interface.
- <PostLink url="https://vercel.com/docs/concepts/functions/introduction">
    Vercel serverless functions
  </PostLink> for the API layer... written in Typescript.
- <PostLink url="https://fauna.com/">FaunaDB</PostLink> for the database.

The app uses <PostLink url="https://react-query.tanstack.com/">React Query</PostLink> for data fetching and client side cache management. I think this can be greatly improved.
...
This is one reason why hiring the right <PostLink slug="/">Chaleston web designer</PostLink> makes all the difference.
